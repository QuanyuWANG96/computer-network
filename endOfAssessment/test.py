...
def topology():
    ...
    s1.cmd("ovs-ofctl add-flow s1 priority=65535,ip,nw_dst=10.0.1.1/24,actions=output:1")
    ...
    s2.cmd("ovs-ofctl add-flow s2 priority=65535,ip,nw_dst=10.0.2.1,actions=output:1")
