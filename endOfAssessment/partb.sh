...
#
#ifconfig Robert-eth0 0
#ifconfig Robert-eth1 0
#ifconfig Robert-eth0 hw ether 00:00:00:00:01:01
#ifconfig Robert-eth1 hw ether 00:00:00:00:01:02
#ip addr add 10.1.1.14/24 brd + dev Robert-eth0
#ip addr add 10.4.4.14/24 brd + dev Robert-eth1
#
#ifconfig Richard-eth0 0
#ifconfig Richard-eth1 0
#ifconfig Richard-eth0 hw ether 00:00:00:00:02:01
#ifconfig Richard-eth1 hw ether 00:00:00:00:02:02
#ip addr add 10.4.4.46/24 brd + dev Richard-eth0
#ip addr add 10.6.6.46/24 brd + dev Richard-eth1
#
#ifconfig Rupert-eth0 0
#ifconfig Rupert-eth0 hw ether 00:00:00:00:03:01
#ip addr add 10.6.6.254/24 brd + dev Rupert-eth0
...
#ip route add 10.1.1.0/24 via 10.6.6.46 dev Carol-eth0
#ip route add 10.4.4.0/24 via 10.6.6.46 dev Carol-eth0
#ip route add 10.1.1.0/24 via 10.4.4.14 dev Bob-eth0
#
